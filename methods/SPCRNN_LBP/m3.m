...
lambda = [1e-4 1e-3 1e-2 1e-1  1 1.5 2 5 8 10];
% lambda = [];
...
for it = 1:length(lambda)
    ...
    lamb = lambda(it);
    [distance] = SPCRNN(im_2d, test_data_ori , tt_index, train_data_ori, D_label,superpixel_label, K_1,K_2,index,index_map, lamb);
