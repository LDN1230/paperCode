function [TrainingTime, TestingTime, TrainingAccuracy, TestingAccuracy,TY,pred_label] = elm_kernel(train_data, test_data, Elm_Type, Regularization_coefficient, Kernel_type, Kernel_para)
...
%%%%%%%%%% Calculate training & testing classification accuracy
    ...
    for i = 1 : size(TV.T, 2)
        ...
        pred_label = [pred_label, label_index_actual];
        if label_index_actual~=label_index_expected
